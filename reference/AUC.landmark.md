...
This function calculates the AUC given the data (truth) and
corresponding estimated probabilities; uses a continuity correction.
...
#> Error in AUC.landmark(t0 = t0, tau = tau, data = out$data): could not find function "AUC.landmark"
```
