...
[![Codecov test coverage](https://codecov.io/gh/baolong281/landpred/graph/badge.svg)](https://app.codecov.io/gh/baolong281/landpred)
<!-- badges: end -->
...
on these models can be found in Parast et al. (2012, Journal of the American Statistical Association, doi:10.1080/01621459.2012.721281), and 
...
We must first choose our bandwidth value. We provide a utility to select this optimal value using K-fold 
cross validations
...
We can also do prediction wiih this model to get survival probabilities for a given observation.
